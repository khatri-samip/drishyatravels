...
--
-- Architecture:
--   Frontend -> Django Backend -> Supabase PostgreSQL
--
-- This migration:
--   1. Creates the package database structure
...
CREATE INDEX IF NOT EXISTS idx_packages_difficulty
    ON packages(difficulty);

CREATE INDEX IF NOT EXISTS idx_itinerary_days_package_id
    ON itinerary_days(package_id);

CREATE INDEX IF NOT EXISTS idx_package_highlights_package_id
    ON package_highlights(package_id);

CREATE INDEX IF NOT EXISTS idx_package_inclusions_package_id
    ON package_inclusions(package_id);

CREATE INDEX IF NOT EXISTS idx_package_exclusions_package_id
    ON package_exclusions(package_id);

CREATE INDEX IF NOT EXISTS idx_package_gallery_package_id
    ON package_gallery(package_id);

CREATE INDEX IF NOT EXISTS idx_package_faqs_package_id
    ON package_faqs(package_id);
...
ON CONFLICT (id) DO UPDATE SET
    ...
    maximum_altitude = EXCLUDED.maximum_altitude,
    starting_point = EXCLUDED.starting_point,
    ending_point = EXCLUDED.ending_point,
...
('everest-base-camp', 1,
 ...
 'Panoramic arrival into Kathmandu, airport meet-and-greet, hotel transfer and briefing. Overnight at Hotel Marshyangdi.'),

('everest-base-camp', 2,
 'Kathmandu Sightseeing',
 'Sightseeing at Pashupatinath, Boudhanath and Patan Durbar Square. Overnight at Hotel Marshyangdi.'),

('everest-base-camp', 3,
 'Fly to Lukla · Trek to Phakding',
 'Fly to Lukla (2840m, approximately 45 minutes) and trek to Phakding (2610m, approximately 3–4 hours).'),

('everest-base-camp', 4,
 'Trek to Namche Bazar',
 'Trek from Phakding to Namche Bazar (3450m, approximately 6–7 hours), crossing suspension bridges and entering Sagarmatha National Park.'),

('everest-base-camp', 5,
 'Acclimatization in Namche Bazar',
 'Explore Namche Bazar and optional hikes around Khunde, Khumjung and the Everest View Hotel.'),

('everest-base-camp', 6,
 'Trek to Tengboche',
 'Trek to Tengboche (3867m, approximately 5–6 hours), with views of Everest, Lhotse, Nuptse and Ama Dablam.'),

('everest-base-camp', 7,
 'Trek to Dingboche',
 'Descend through forest, cross the Imja Khola and continue to Dingboche (4410m).'),

('everest-base-camp', 8,
 'Rest Day in Dingboche',
 'Acclimatization day with options including Nangkartshang Peak, Chhukung Village or Chhukung Ri.'),

('everest-base-camp', 9,
 'Trek to Lobuche',
 'Continue beneath Cholatse and Tawoche, pass the Khumbu Glacier moraine and reach Lobuche (4930m).'),

('everest-base-camp', 10,
 'Goraksheop · Everest Base Camp · Gorakshep',
 'Trek to Goraksheop (5184m), continue to Everest Base Camp (5357m) and return to Gorakshep; approximately 7–8 hours.'),

('everest-base-camp', 11,
 'Kala Patthar · Pheriche',
 'Morning climb to Kala Patthar (approximately 5545m), return to Gorakshep and trek to Pheriche (4371m), approximately 7–8 hours.'),

('everest-base-camp', 12,
 'Trek to Namche Bazar',
 'Mostly downhill trekking following the river, passing Tengboche and returning to Namche Bazar (3450m).'),

('everest-base-camp', 13,
 'Trek to Lukla',
 'Final trekking day following the Dudh Koshi to Lukla (2840m), with a farewell celebration in the evening.'),

('everest-base-camp', 14,
 'Fly Back to Kathmandu',
 'Fly back to Kathmandu and transfer to the hotel. Free time for shopping or exploring Thamel.'),
...
('mardi-trek', 1,
 'Pokhara to Deaurali',
 'Guide pickup from Pokhara and drive to Kande. Trek to Pitan Deurali (1925m), about 4 hours. Overnight at the lodge.'),

('mardi-trek', 2,
 'Deurali to Low Camp',
 'Trek from Pitan Deurali to Low Camp (2985m). Lunch at Forest Camp (2600m) after about four hours. Total trekking time is about 6 hours. Overnight at the lodge.'),

('mardi-trek', 3,
 'Low Camp to High Camp',
 'Trek from Low Camp to High Camp (3,700m). Enjoy views of Machhapuchhre ahead and Annapurna South to the left. Trek takes about four hours. Overnight at the lodge.'),

('mardi-trek', 4,
 'High Camp to Mardi to Badal Danda',
 'Hike to Mardi Himal Base Camp (4500m) and return to High Camp, approximately 4–5 hours round trip. Then trek down to Badal Danda (3210m) and overnight at a lodge.'),

('mardi-trek', 5,
 'Badal Danda to Pokhara',
 'Trek to Siding village for about 5 hours and drive back to Pokhara.'),

-- Rani Mahal
('rani-mahal', 1,
 'KTM – Tansen',
 'Depart Kathmandu at 6:00 AM. Drive through Nagdhunga, Chitwan and the Daunne section, enter Butwal and head uphill to Tansen. Overnight at Hotel Pauwa Palpa.'),

('rani-mahal', 2,
 'Tansen – Rani Mahal',
 'Breakfast at Hotel Pauwa Palpa, then drive approximately 13 km from Tansen to Rani Mahal. Explore the palace and Kali Gandaki River, take photos/videos and return to the hotel for the night.'),

('rani-mahal', 3,
 'Tansen – Kathmandu',
 'Wake up at 8:00 AM, have breakfast, pack belongings and depart for Kathmandu by drive.'),

-- Manang
('manang', 1,
 'KTM – Chame',
 'Depart Kathmandu at 6:00 AM. Drive through Trishuli River, Mugling and Chitwan, then via Dumre to the Besisahar–Chame road. Continue the off-road route beside the Marshyangdi River to Chame. Overnight at Hotel New Shangrila.'),

('manang', 2,
 'Chame – Pisang',
 'Wake early for mountain views, have breakfast and drive to Pisang. Enjoy the apple farming and Manang Valley. Overnight at Hotel Himalayan Mountain Bridge and rooftop restaurant.'),

('manang', 3,
 'Explore Pisang',
 'Explore Green Lake, then continue to Blue Lake and Gangapurna. Return to the hotel for dinner and overnight.'),

('manang', 4,
 'Pisang – Besisahar',
 'Wake early and pack by 8:00 AM. Have breakfast and drive back to Besisahar, enjoying the Marshyangdi gorge and Octopus Fall.'),

('manang', 5,
 'Besisahar – Kathmandu',
 'Wake early, have breakfast, pack belongings and depart for Kathmandu.')
...
INSERT INTO package_highlights
    (package_id, highlight, display_order)
VALUES
...
INSERT INTO package_inclusions
    (package_id, inclusion, display_order)
VALUES
...
INSERT INTO package_exclusions
    (package_id, exclusion, display_order)
VALUES
